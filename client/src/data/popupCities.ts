...
export const popupCities: PopupCity[] = [
  ...
  */
  ...
  /* 
  {
    name: "H.E.R. DAO Tech City",
    status: "UPCOMING",
    brand: "🏙️✨ HERDAO",
    year: 2024,
    dateRange: "October 7, 2024 → November 5, 2024",
    websiteUrl: "https://www.her-dao.xyz/",
    twitterUrl: "https://x.com/_herdao",
    description: "A month's immersion in a tech city for women developers",
    oneLiner: "A month-long tech city immersion for women developers.",
    location: {
      city: "Chiang Mai",
      country: "THAILAND"
    }
